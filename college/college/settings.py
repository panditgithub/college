...
ALLOWED_HOSTS = os.environ.get("ALLOW_HOSTS", "college-qqhu.onrender.com,127.0.0.1,localhost,aiiedu.online").split(",")
# ALLOWED_HOSTS = ['*']
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'collegeApp', 'static')]
